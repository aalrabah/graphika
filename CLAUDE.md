...
- `findings.txt` is an append-only, dated investigation log (root causes, benchmarks, things ruled out) — check it before re-investigating something that may already be diagnosed.
